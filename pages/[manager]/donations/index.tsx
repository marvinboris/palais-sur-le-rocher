...
import { DonationInterface } from "../../../app/models/donation";
...
const ManageDonationsPage: NextPageWithLayout = () => {
  ...
  const data = (
    backend && backend[resource]
      ? (backend[resource] as DonationInterface[])
      : []
  ).map((item) =>
    updateObject(item, {
...
ManageDonationsPage.getLayout = function getLayout(page: ReactElement) {
