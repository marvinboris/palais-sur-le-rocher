...
const renderMinistry = (ministry: MinistryType, index: number) => (
  <MinistryBlock key={`ministry-${ministry.name}-${index}`} {...ministry} />
);
const renderImage = (image: ImageType, index: number) => (
  <ImageBlock key={`image-${image.photo}-${index}`} {...image} />
);
const renderEvent = (event: EventType, index: number) => (
  <EventBlock key={`event-${event.link}-${index}`} {...event} />
);
const renderTestimony = (testimony: TestimonialType, index: number) => (
  <TestimonialBlock
    key={`testimony-${testimony.body}-${index}`}
    {...testimony}
  />
);
...
const HomePage: NextPageWithLayout<HomePageProps> = ({ home }) => {
  ...
  for (let i = 0; i < Math.ceil(testimonies.length / 2); i++) {
    testimoniesContent.push(
      <li key={`testimoniesContent-${i}`}>
        <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
          {renderTestimony(testimonies[2 * i], 2 * i)}
          {testimonies.length > 2 * i + 1 &&
            renderTestimony(testimonies[2 * i + 1], 2 * i + 1)}
        </ul>
      </li>
    );
  }
  ...
  return (
    <>
      <Head {...params} />
      <main>
        <header className="container flex flex-col items-center justify-center py-40 text-center lg:py-52">
          <p className="font-display mb-6 text-lg font-semibold text-primary-600">
            Mission évangélique du secours divin
          </p>

          <h1 className="font-display mx-auto max-w-4xl text-5xl font-extrabold tracking-tight text-secondary-900 dark:text-white sm:text-7xl">
            Palais sur le Rocher
          </h1>

          <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-secondary-600 dark:text-secondary-400">
            Notre mission est de bâtir des rois, changer des vies, sauver des
            âmes pour la gloire du Seigneur Jésus-Christ.
          </p>
        ...
        <section
          id="about"
          aria-label="Palais sur le Rocher"
            ...
            <div className="mx-auto">
              <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                <div className="lg:pl-20">
                  <div className="lg:max-x-lg xl:max-x-xl mx-auto max-w-xs px-2.5 sm:max-w-sm md:max-w-md">
                    <NextImage
                      width={1920}
                      height={1920}
                      ...
                      decoding="async"
                      data-nimg="future"
                      className="aspect-square rounded-2xl bg-secondary-100 object-cover text-transparent dark:bg-secondary-800"
                      loading="lazy"
                    />
                  </div>
                </div>
                ...
                <div className="lg:order-first lg:row-span-2">
                  <div className="section-header">
                    <h1 className="section-header-title lg:text-left">
                      Bienvenue au Palais sur le Rocher
                    </h1>
                  </div>
                  ...
                  <div className="mt-6 space-y-7 text-base text-secondary-600 dark:text-secondary-400">
                    <p>
                      ...
                      Rem, animi officia ipsum deserunt consequuntur architecto
                      consequatur quidem reiciendis sed quibusdam consectetur,
                      eum corrupti. Quis quam atque nobis facere similique eum!
                    </p>
                    <p>
                      Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                      Rem, animi officia ipsum deserunt consequuntur architecto
        ...
        <section
          id="publications"
          aria-label="Dernières nouvelles sur Palais"
          className="section"
        >
          <div className="container">
            <div className="section-header">
              ...
              <p className="section-header-subtitle">
                Ecoutez des derniers enseignements, des oeuvres de
                l&apos;Eternel dans la vie de son peuple.
              </p>
            </div>

            <ul className="section-body grid grid-cols-1 text-sm leading-6 md:grid-cols-2 md:gap-6 xl:grid-cols-3">
              {publicationsContent}
            </ul>
          </div>
        </section>
        ...
        <section
          id="ministries"
          aria-label="Les ministères"
          className="section dark:bg-secondary-800"
        >
          <div className="container">
            <div className="section-header">
            ...
            <div className="section-body grid grid-cols-2 gap-6 md:grid-cols-3 lg:mt-20 lg:grid-cols-4 xl:grid-cols-6">
              {ministriesContent}
            </div>
          </div>
        </section>
        ...
        <section
          id="testimonials"
          aria-label="Quelques témoignages"
          className="section bg-secondary-50 dark:bg-secondary-900"
        >
          <div className="container">
            <div className="flex-wrap items-center lg:-mx-3 lg:flex">
              <div className="lg:w-6/12 lg:px-3 xl:w-5/12">
                <div className="section-header">
                  <h2 className="section-header-title">
                    Les merveilles de notre Seigneur
                  </h2>

                  <p className="section-header-subtitle">
                    Nous sommes incapables de dénombrer les bienfaits de
                    l&apos;Eternel dans nos vies mais il nous arrive parfois
              ...
              <div className="mt-16 lg:mt-0 lg:w-6/12 lg:px-3 xl:w-7/12">
        ...
        <section
          id="events"
          aria-label="Les moments privilégiés"
          className="section dark:bg-secondary-800"
        >
          <div className="container">
            <div className="section-header">
              ...
              <p>
                Car se retrouver dans la présence de Dieu est un privilège, nous
                en profitons et invitons tout un chacun à en profiter avec nous.
              </p>
            </div>

            <ul
              role="list"
              className="section-body grid grid-cols-2 gap-6 sm:gap-8 md:grid-cols-3 lg:mt-20 xl:grid-cols-4"
            >
              {eventsContent}
            </ul>
          </div>
        ...
        <section
          id="map"
          aria-label="Trouver le Palais"
          className="bg-secondary-100 dark:bg-secondary-800"
        >
          <iframe
            src="https://www.google.com/maps/d/embed?mid=1qxttzUZkrtU0Q2Pnr0BgOAGLrsOz4YpQ&ehbc=2E312F"
        ...
        <section id="newsletter" className="section">
          <div className="container grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="section-header lg:text-left">
              ...
              <p className="section-header-subtitle">
                Restez à l&apos;écoute des derniers enseignements, des oeuvres
                de l&apos;Eternel dans la vie de son peuple.
              </p>
            </div>

            <div className="section-body">
              <form>
                <h3 className="text-lg font-semibold tracking-tight text-primary-900 dark:text-white">
                  Souscrire à notre newsletter <span aria-hidden="true">↓</span>
                </h3>
                ...
                <div className="mt-5 flex rounded-3xl bg-white py-2.5 pr-2.5 shadow-xl shadow-primary-900/5 focus-within:ring-2 focus-within:ring-primary-900 ">
                  <input
                    ...
                    className="-my-2.5 flex-auto bg-transparent pl-6 pr-2.5 text-base text-secondary-900 placeholder:text-secondary-400 focus:outline-none"
                  />

                  <button
                    className="inline-flex justify-center rounded-2xl bg-primary-600 p-4 text-base font-semibold text-white focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 hover:bg-primary-500 active:text-white/70"
                    type="submit"
                  >
