        ...
        <header className="relative">
          <div className="bg-img">
            <Image
              width={1920}
              height={1920}
              src="/images/jeremy-yap-eCEj-BR91xQ-unsplash.jpg"
              alt="Donner"
          ...
          <div className="container relative z-10 text-secondary-50">
            <p className="text-xs uppercase sm:text-sm">Faire un don</p>

            <h1 className="text-4xl font-extrabold md:text-6xl">Donner</h1>
...
export async function getServerSideProps() {
  ...
  return {
    props: {
      give: JSON.parse(
        JSON.stringify(methods.map((method) => method.toObject()))
      ),
    },
  };
}
