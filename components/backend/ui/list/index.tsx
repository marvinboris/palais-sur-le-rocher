        ...
        <div className="flex items-center justify-between">
            ...
            <div className="pt-2 d-flex justify-content-end">
                {show !== "All" && <div className="inline-flex text-sm space-x-2.5 items-center p-1 rounded-3xl bg-white border border-yellow/40 relative z-0 overflow-hidden after:absolute after:inset-0 after:bg-yellow/20 after:-z-10">
                    {page !== 1 && <>
                        <div className='w-7 h-7 cursor-pointer rounded-full flex items-center justify-center bg-primary-600 text-white' onClick={firstPageHandler}><ChevronDoubleLeftIcon className='w-3.5' /></div>
                    ...
                    {pageNumber > 1 && <>
                        ...
                        {page !== pageNumber && <>
                            ...
                            <div className='w-7 h-7 cursor-pointer rounded-full flex items-center justify-center bg-primary-600 text-white' onClick={lastPageHandler}><ChevronDoubleRightIcon className='w-3.5' /></div>
                        </>}
                    </>}
                </div>}
            </div>
