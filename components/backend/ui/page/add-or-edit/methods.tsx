...
export default function ManageAddOrEditMethods({ edit }: Props) {
    ...
    return <ManagerAddOrEdit icon={CreditCardIcon} edit={edit} resource='methods' singular='method' initialState={initialState} state={state} setState={setState} staticChild={<>
