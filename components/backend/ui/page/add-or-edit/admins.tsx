...
export default function ManageAddOrEditAdmins({ edit }: Props) {
    ...
    return <ManagerAddOrEdit icon={UserGroupIcon} edit={edit} resource='admins' singular='admin' initialState={initialState} state={state} setState={setState} staticChild={<>
