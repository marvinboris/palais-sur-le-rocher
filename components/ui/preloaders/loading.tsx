...
export default function Loading({ children, loading }: LoadingProps) {
    ...
    return <>
        <div className={classNames('absolute inset-0 flex items-center justify-center bg-white z-50 after:absolute after:inset-0 after:bg-grid-primary-600/[0.05] after:z-40 transition-all duration-1000', fadedOut ? "opacity-0 scale-0" : "opacity-100 scale-0")}>
