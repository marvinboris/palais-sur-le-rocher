...
export default function Layout({ children }: LayoutProps) {
    ...
    return !token ? <div className="overflow-hidden bg-grid-primary-600/[0.05] relative z-0">
        <div className='bg-gradient-to-t from-primary-600/50 to-transparent absolute inset-0 -z-10' />
