...
export default function PageTitle({ title, subtitle }: PageTitleProps) {
    return <div className='relative z-0 py-20'>
        ...
        <div className='bg-grid-white/[0.05] absolute -z-10 after:absolute after:bottom-0 after:inset-0 after:bg-gradient-to-t after:from-primary-600/70 after:to-primary-600/30 after:-z-20 inset-0' />
