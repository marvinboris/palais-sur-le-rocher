...
export const Donation = models.Donation as Model<DonationInterface> || model<DonationInterface>("Donation", DonationSchema)
...
export const Member = models.Member as Model<MemberInterface> || model<MemberInterface>("Member", MemberSchema)
...
export const Tithe = models.Tithe as Model<TitheInterface> || model<TitheInterface>("Tithe", TitheSchema)
